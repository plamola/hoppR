...
object HelloPostgres extends App {

  // The query interface for the Suppliers table
  val suppliers: TableQuery[Tables.Suppliers] = TableQuery[Tables.Suppliers]

  // the query interface for the Coffees table
  val coffees: TableQuery[Tables.Coffees] = TableQuery[Tables.Coffees]
  
  // Create a connection (called a "session") to an in-memory H2 database
//  val db = Database.forURL("jdbc:h2:mem:hello", driver = "org.h2.Driver")
//  db.withSession { implicit session =>

    val db =  Database.forURL(url = "jdbc:postgresql://localhost/feedrdev", user ="feedr" , password ="narcoticflowerelecticgrey",
    ...
    val filterQuery: Query[Tables.Coffees, (String, Int, Double, Int, Int), Seq] =
    ...
    val deleteQuery: Query[Tables.Coffees,(String, Int, Double, Int, Int), Seq] =
    ...
    val sortByPriceQuery: Query[Tables.Coffees, (String, Int, Double, Int, Int), Seq] =
